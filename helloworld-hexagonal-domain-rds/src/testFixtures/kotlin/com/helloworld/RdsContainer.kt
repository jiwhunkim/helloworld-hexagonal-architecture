...
object RdsContainer: AbstractProjectConfig() {
    val rdsContainer = MariaDBContainer<Nothing>(
        DockerImageName
        ...
        withUsername("root")
        withPassword("")
        withCommand("--skip-character-set-client-handshake --character-set-server=utf8mb4 --collation-server=utf8mb4_general_ci --character-set-filesystem=utf8mb4")
    }
